...
class LikedBookCard extends StatefulWidget {
  LikedBookCard({this.uid, Key key, Book book}) : super(key: key);
  final String uid;
  @override
  _LikedBookCardState createState() => _LikedBookCardState();
}

class _LikedBookCardState extends State<LikedBookCard> {
  final dbRef = FirebaseFirestore.instance.collection("LikedBooks");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Patikusios knygos")),
      body: Container(
                              ...
                              onPressed: () {
                                showDialog(
                                  ...
                                  builder: (context) => AlertDialog(
                                    title: Text("Dėmesio!"),
                                    content: Text(
                                        "Ar tikrai norite šią patikusia knygą?"),
                                    actions: [
                                      FlatButton(
                                        child: Text("Gerai"),
                                        onPressed: () {
